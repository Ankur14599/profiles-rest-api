...
class HelloApiView(APIView):
    """Test API View"""
    serializer_class = serializers.HelloSerializer #standard way to initate Serializer
...
class HelloViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        a_viewset = [
            ...
            'Automatically maps URLs', 
            'Provides functions with less code'
        ]
...
class UserProfileApiView(ObtainAuthToken):
    """Obtain auth token for login"""
